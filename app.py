...
def build_public_stats() -> dict:
    ...
    return {
        "asset_version": ANALYTICS_ASSET_VERSION,
        "demo_accounts": {
            "investor": {"username": "investor_1", "password": "demo123"},
            "inventor": {"username": "inventor_1", "password": "demo123"},
        },
        "selection_rule": {
            "summary": "Best model is chosen by the average of accuracy, precision, recall, F1, ROC AUC, and PR AUC.",
            "tie_breaker": "If scores are extremely close, ROC AUC and PR AUC are used to break the tie.",
        },
